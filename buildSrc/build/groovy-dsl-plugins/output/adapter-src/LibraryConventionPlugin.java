...
/**
 * Precompiled library-convention script plugin.
 **/
public class LibraryConventionPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_LibraryConvention").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("secagg-common-convention");
            target.getPluginManager().apply("java-library");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_LibraryConvention").asSubclass(BasicScript.class);
